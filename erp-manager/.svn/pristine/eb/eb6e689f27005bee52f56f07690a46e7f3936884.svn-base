...
<body>
			...
			<form class="form form-horizontal" method="post">
				<div class="row cl">
					...
					<div class="formControls col-xs-8">
						<input id="userName" name="userName" type="text" value="admin" placeholder="账户"
				...
				<div class="row cl">
					<label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
					<div class="formControls col-xs-8">
						<input id="userPwd" name="userPwd" type="password" value="123" placeholder="密码"
							class="input-text size-L">
					</div>
				</div>
				<div class="row cl">
    ...
    $("#btn").click(function() {
        $.ajax({
            url: "${pageContext.request.contextPath}/check",//要请求的服务器url 
